...
class Kernel extends HttpKernel
{
    ...
    protected $middlewareGroups = [
        'web' => [
            ...
            Middleware\JavascriptForViews::class,
            Middleware\PaymentsForTesters::class,
        ],
    ...
    protected $routeMiddleware = [
        ...
        'api.middleware' => Middleware\ApiMiddleware::class,
        'api.store' => Middleware\StoreApiMiddleware::class,
    ];
}
