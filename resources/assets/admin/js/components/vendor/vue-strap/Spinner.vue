<template>
  <div :class="['spinner spinner-gritcode cur-w',spinnerSize,{'spinner-fixed':fixed}]" v-show="active">
    <div class="spinner-wrapper">
      <div class="la-ball-spin la-3x color-primary"><div></div><div></div><div></div><div></div><div></div><div></div><div></div><div></div></div>
...
<script>
const { coerce } = require('vue-strap/src/utils/utils.js');
