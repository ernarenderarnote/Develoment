                        ...
                        <tbody>
                            @forelse($formObject->model->models as $model)
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <div>@lang('labels.color'): {{ App\Models\ProductModelTemplate::getColorName($model->color)->name ? App\Models\ProductModelTemplate::getColorName($model->color)->name : '' }}</div>
                                        <div>@lang('labels.size'): {{ App\Models\ProductModelTemplate::getSizeName($model->size)->name ? App\Models\ProductModelTemplate::getSizeName($model->size)->name : '' }}</div>
                                    </td>
                                    <td>
                                    ...
                                    <td>
                                        <div>
                                            @lang('labels.price'): {{ $model->price }}

                                            @if(!$model->price)
                                                <i class="fa fa-exclamation-triangle color-warning" title="@lang('labels.price_not_set')"></i>
                                            @endif
                                        </div>
                                        <div>@lang('labels.back_price'): {{ $model->price_back }}</div>
                                        <div>@lang('labels.both_sides_price'): {{ $model->price_both }}</div>
                                    </td>
                                </tr>
