...
@section('content')
   ...
   {{-- @if($tour)
        <button id="continue-tour" class="btn btn-primary">Continue Tour</button>
    @endif --}}

@endsection

@section('introJs')
    @if($tour && $firstConnect)
        ...
        <script>
            ...
            intro.setOptions({
                steps: [
                    { intro: "Please, fill in the Billing Address and click update." }
                ],
                nextLabel: 'Continue',
                prevLabel: 'Back',
                skipLabel: 'End Tour',
