...
@section('content')
    <script>
        App.data.Store = {!! json_encode($store->transformBrief()) !!};
    </script>
                ...
                <div class="container">
                    <div class="row">
                        <div class="col-xs-12 col-sm-12 col-md-12">
                            ...
                            <tabs :active.sync="activeTab" justified>
                                <tab class="show" header="@lang('actions.synced')">
                                    @include('dashboard.store.sync.synced-tab', [
                                        'products' => $store->vendorProductsSynced
                                    ])
                                </tab>
                                <tab class="show" header="@lang('actions.pending')">
