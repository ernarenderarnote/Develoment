<modal :show.sync="showAddProductModal" :large="true" :backdrop="false" >
  ...
  <div slot="modal-body" class="modal-body add-product-modal">
    <add-product-wizard
        inline-template="true"
        :update-product="updateProduct"
        :is-loading.sync="addProductWizardLoading"
